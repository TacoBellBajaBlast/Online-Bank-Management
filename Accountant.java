...
public class Accountant {
	...
	Bank_Account searchAccount1(String accountNum, String SSID) {
		...
		Bank_Account account = db.searchAccount1(accountNum, SSID);
		db = null;
	...
	public Client searchClient1(String accountNum, String SSID) {
		DB_Handler db = new DB_Handler();
		Client client = db.searchClient1( accountNum, SSID );
		db = null;
		return client;
	}
