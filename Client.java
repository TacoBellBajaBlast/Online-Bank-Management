...
public class Client {
	...
	public Client(String f_name, String l_name, String father_name, String mother_name, String ssid, String dob, String phone, String email, String address) {
		client_id = "";
		this.f_name = f_name;
		this.l_name = l_name;
	...
	// Parameterized Constructor
	public Client(String id, String pf_name, String pl_name, String pfather_name, String pmother_name, String pssid, String pdob, String pphone, String pemail, String paddress) {
		this.client_id = id;
		this.f_name = pf_name;
		this.l_name = pl_name;
	...
	void showClientInfo() {
		...
		System.out.println("SSID Name: "+SSID);
